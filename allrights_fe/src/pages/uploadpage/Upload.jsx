  ...
  return (
    <Home>
      <HomeContainer>
        ...
        <UploadInput
        value={title}
        onChange={(e) => setTitle(e.target.value)} placeholder ="타이틀을 입력해주세요"/>
        ...
        <SearchButton onClick={handleBrowseClick} style={{marginLeft:"1vw", marginRight:"3vw"}}>Browse File</SearchButton>
        <SubmitButton onClick={handleSubmit}>Submit</SubmitButton>
        </UploadContainer>

        <ButtonContainer> {/*버튼 둘중 하나 선택되었을 때 효과*/}
        ...
        <UploadInput placeholder="설명을 입력해주세요"
